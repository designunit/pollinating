...
<Timeline>
    ...
    <TimelineItem title="FIRST WAVE OF PROPOSALS" bullet={1}>
    </TimelineItem>
    ...
    <TimelineItem title="2 WAVE OF PROPOSALS" bullet={2}>
    </TimelineItem>
    ...
    <TimelineItem title="NEW YEAR'S EVE PARTY IN DECEMBER (DATE TO BE SPECIFIED)" bullet={"snowflake"}>
    </TimelineItem>
</Timeline>
